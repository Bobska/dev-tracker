...
urlpatterns = [
    ...
    path(
        "projects/<int:pk>/dashboard/",
        views.project_dashboard_view,
    ...
    path(
        "artifacts/<int:pk>/edit/",
        views.ArtifactUpdateView.as_view(),
        name="artifact_update",
    ),
    path(
        "artifacts/<int:pk>/delete/",
        views.ArtifactDeleteView.as_view(),
        name="artifact_delete",
    ),
    path(
        "artifacts/<int:pk>/download/",
        views.artifact_download_view,
    ...
    path(
        "decisions/<int:pk>/",
        views.DecisionDetailView.as_view(),
        name="decision_detail",
    ),
    path(
        "decisions/<int:pk>/edit/",
        views.DecisionUpdateView.as_view(),
        name="decision_update",
    ),
    path(
        "decisions/<int:pk>/delete/",
    ...
    path(
        "integrations/new/",
        views.IntegrationCreateView.as_view(),
    ...
    path(
        ...
        views.IntegrationUpdateView.as_view(),
        name="integration_update",
    ),
    path(
        "integrations/<int:pk>/delete/",
