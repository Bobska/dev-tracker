...
class ApplicationInline(admin.TabularInline):
    ...
    readonly_fields = ["task_completion_percentage"]
...
class ProjectAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ("Project Timeline", {"fields": ("status", "start_date", "target_date")}),
        (
            "Statistics",
            {
...
class ApplicationAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ["created_at", "updated_at", "task_completion_percentage"]
    ...
    fieldsets = [
        ...
        (
            "Statistics",
            {"fields": ("task_completion_percentage",), "classes": ("collapse",)},
        ),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
    ...
    def task_completion_display(self, obj):
        percentage = obj.task_completion_percentage
        if percentage >= 90:
            color = "#28a745"  # green
        elif percentage >= 50:
            color = "#ffc107"  # yellow
    ...
    mark_as_development.short_description = (
        "Mark selected applications as in development"
    )
...
class ArtifactAdmin(admin.ModelAdmin):
    ...
    list_filter = ["application", "artifact_type", "status", "created_at"]
    search_fields = ["name", "description", "application__name"]
    readonly_fields = ["created_at", "updated_at", "file_size_mb"]

    fieldsets = [
        ("Basic Information", {"fields": ("application", "name", "description")}),
        ("Artifact Details", {"fields": ("artifact_type", "status", "version")}),
        (
            "Content",
            {
    ...
    def artifact_type_badge(self, obj):
        ...
        return format_html(
            '<span style="background-color: {}; color: white; padding: 3px 8px; border-radius: 3px; font-size: 11px;">{}</span>',
            colors.get(obj.artifact_type, "#6c757d"),
            obj.get_artifact_type_display(),
        )
...
class TaskAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ("Basic Information", {"fields": ("application", "title", "description")}),
        ("Task Details", {"fields": ("priority", "status", "assignee", "due_date")}),
        (
            "Time Tracking",
            {"fields": ("estimated_hours", "actual_hours"), "classes": ("collapse",)},
        ),
        ("Status Information", {"fields": ("is_overdue",), "classes": ("collapse",)}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
    ...
    def assignee_badge(self, obj):
        ...
        icons = {"claude": "🤖", "github-copilot": "🧑‍💻", "human": "👤", "team": "👥"}
        return format_html(
            '<span style="background-color: {}; color: white; padding: 3px 8px; border-radius: 3px; font-size: 11px;">{} {}</span>',
    ...
    def overdue_indicator(self, obj):
        if obj.is_overdue:
            return format_html(
                '<span style="color: #dc3545; font-size: 16px;" title="Task is overdue">⚠️</span>'
            )
        elif obj.due_date:
            days_left = (obj.due_date - timezone.now().date()).days
            if days_left <= 1:
                return format_html(
                    '<span style="color: #ffc107; font-size: 16px;" title="Due soon">⏰</span>'
                )
            else:
                return format_html(
        ...
        return format_html(
            '<span style="color: #6c757d;" title="No due date">➖</span>'
        )
...
class DecisionAdmin(admin.ModelAdmin):
    ...
    fieldsets = [
        ...
        ("Timeline", {"fields": ("age_in_days",), "classes": ("collapse",)}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class IntegrationAdmin(admin.ModelAdmin):
    ...
    list_filter = ["integration_type", "complexity", "from_application__project"]
    search_fields = [
        "name",
        "description",
        "from_application__name",
        "to_application__name",
    ]
    readonly_fields = ["created_at", "updated_at"]

    fieldsets = [
        ("Integration Overview", {"fields": ("name", "description")}),
        (
            "Integration Details",
            {"fields": ("from_application", "to_application", "integration_type")},
        ),
        ("Planning", {"fields": ("complexity", "estimated_hours")}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
    ...
    def from_application(self, obj):
        return format_html(
            ...
            reverse("admin:tracker_application_change", args=[obj.from_application.pk]),
            obj.from_application.name,
        )
    ...
    def to_application(self, obj):
        return format_html(
            '<a href="{}" title="View application">{}</a>',
            reverse("admin:tracker_application_change", args=[obj.to_application.pk]),
            obj.to_application.name,
        )
